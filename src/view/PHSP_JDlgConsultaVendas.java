 ...
 * @author Marcos
 */
public class PHSP_JDlgConsultaVendas extends javax.swing.JDialog {

    PHSP_ControllerConsultasVendas controllerConsultasVendas;
            /**
             * Creates new form JDlgUsuariosPesquisar
             */

    public PHSP_JDlgConsultaVendas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Consultando Vendas");
        controllerConsultasVendas = new PHSP_ControllerConsultasVendas();
...
//        jTable1.setModel(controllerUsuarios);
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        ...
        PhspVendasDAO phspVendasDAO = new PhspVendasDAO();
        List lista;
        if ((jTxtID.getText().isEmpty() == false)
                && (jTxtTotal.getText().isEmpty() == false)) {
            lista = (List) phspVendasDAO.listIDTotal(Util.strToInt(jTxtID.getText()),
                    Util.strToDouble(jTxtTotal.getText()));
        } else if (jTxtID.getText().isEmpty() == false) {
            lista = (List) phspVendasDAO.listID(Util.strToInt(jTxtID.getText()));
        } else if (jTxtTotal.getText().isEmpty() == false) {
            lista = (List) phspVendasDAO.listTotal(Util.strToDouble(jTxtTotal.getText()));
        } else {
            lista = (List) phspVendasDAO.listAll();
        }
        controllerConsultasVendas.setList(lista);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PHSP_JDlgConsultaVendas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PHSP_JDlgConsultaVendas dialog = new PHSP_JDlgConsultaVendas(new javax.swing.JFrame(), true);
