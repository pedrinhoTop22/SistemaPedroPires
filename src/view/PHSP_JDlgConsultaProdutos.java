 ...
 * @author Marcos
 */
public class PHSP_JDlgConsultaProdutos extends javax.swing.JDialog {

    PHSP_ControllerConsultasProdutos controllerConsultasProdutos;
            /**
             * Creates new form JDlgUsuariosPesquisar
             */

    public PHSP_JDlgConsultaProdutos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Consultando Produtos");
        controllerConsultasProdutos = new PHSP_ControllerConsultasProdutos();
...
//        jTable1.setModel(controllerUsuarios);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Preço Maior que ");
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        ...
        if ((jTxtNome.getText().isEmpty() == false)
            ...
            lista = (List) phspProdutosDAO.listNomeValor(jTxtNome.getText(),
                    Util.strToDouble(jTxtValor.getText()));
        } else if (jTxtNome.getText().isEmpty() == false) {
            lista = (List) phspProdutosDAO.listNome(jTxtNome.getText());
        } else if (jTxtValor.getText().isEmpty() == false) {
            lista = (List) phspProdutosDAO.listPreco(Util.strToDouble(jTxtValor.getText()));
        } else {
            lista = (List) phspProdutosDAO.listAll();
        }
        controllerConsultasProdutos.setList(lista);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PHSP_JDlgConsultaProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PHSP_JDlgConsultaProdutos dialog = new PHSP_JDlgConsultaProdutos(new javax.swing.JFrame(), true);
