 ...
 * @author Marcos
 */
public class PHSP_JDlgConsultaClientes extends javax.swing.JDialog {

    PHSP_ControllerConsultasClientes controllerConsultasClientes;
            /**
             * Creates new form JDlgUsuariosPesquisar
             */

    public PHSP_JDlgConsultaClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Consultando Clientes");
        controllerConsultasClientes = new PHSP_ControllerConsultasClientes();
...
//        jTable1.setModel(controllerUsuarios);
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        ...
        if ((jTxtNome.getText().isEmpty() == false)
            ...
            lista = (List) phspClientesDAO.listIDNome(Util.strToInt(jTxtID.getText()),
                    jTxtNome.getText());
        } else if (jTxtNome.getText().isEmpty() == false) {
            lista = (List) phspClientesDAO.listNome(jTxtNome.getText());
        } else if (jTxtID.getText().isEmpty() == false) {
            lista = (List) phspClientesDAO.listID(Util.strToInt(jTxtID.getText()));
        } else {
            lista = (List) phspClientesDAO.listAll();
        }
        controllerConsultasClientes.setList(lista);
    ...
    private void jBtnPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnPDFActionPerformed
        // TODO add your handling code here:                                          
   Util.gerarPDF(jTable1, "Relatório de Clientes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PHSP_JDlgConsultaClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PHSP_JDlgConsultaClientes dialog = new PHSP_JDlgConsultaClientes(new javax.swing.JFrame(), true);
